const PARAMS = {
  ...
  fireSpreadNorm:    0.18,
  fireSpreadRes:     0.07,
  fireSpreadSapling: 0.25,
  fireEmberSpread:   0.05,
...
function resetParams(){
  PARAMS.fireSpreadNorm    = 0.18;
  PARAMS.fireSpreadRes     = 0.07;
  PARAMS.fireSpreadSapling = 0.25;
  PARAMS.fireEmberSpread   = 0.05;
  PARAMS.fireResEmberChance= 0.12;
  PARAMS.infSpread         = 0.25;
  PARAMS.infNbrsMult       = 0.20;
  PARAMS.infSpont          = 0.00008;
  PARAMS.infDeathMin       = 40;
  PARAMS.infDeathRand      = 30;
  ...
  TOGGLES.nbrSpread=true;TOGGLES.spontInfection=true;TOGGLES.rain=true;TOGGLES.humans=false;
}
